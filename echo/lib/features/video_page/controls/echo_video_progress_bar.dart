...
class EchoVideoProgressBar extends StatefulWidget {
  EchoVideoProgressBar(
    this.controller, {
  ...
  _EchoVideoProgressBarState createState() {
    return _EchoVideoProgressBarState();
  }
}

class _EchoVideoProgressBarState extends State<EchoVideoProgressBar> {
  void listener() {
    if (!mounted) return;
    setState(() {});
  }
  ...
  void _seekToRelativePosition(Offset globalPosition) {
    final seekTo = context.calcRelativePosition(
